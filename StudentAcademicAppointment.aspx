    ...
    <table style="margin-left: 5%; margin-top: -2%; width: 100%;">
        <tr >
            ...
            <td style="width: 20%; padding-bottom: 1%;">
                <asp:DropDownList OnMouseDown="this.size=1;" OnFocusOut="this.size=3;" OnDblClick="this.size=1;" ID="ddlDepartment" runat="server" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
            </td>
        ...
        <tr>
            ...
            <td style="width: 20%;">
                <asp:DropDownList OnMouseDown="this.size=1;" OnFocusOut="this.size=3;" OnDblClick="this.size=1;" style="width: 85%;" ID="ddlFaculty" runat="server" OnSelectedIndexChanged="ddlFaculty_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
            </td>
            <td style="text-align: right; padding-right: 2%;">
                 Group Members : 
            </td>
            <td>
                <asp:DropDownList OnMouseDown="this.size=1;" OnFocusOut="this.size=3;" OnDblClick="this.size=1;" ID="ddlGroup" runat="server" OnSelectedIndexChanged="ddlDepartment_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
            </td>
        </tr>
    </table>
