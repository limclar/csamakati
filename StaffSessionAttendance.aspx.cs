        ...
        try
        {
            ...
            else if(e.CommandName == "TimeEnd")
            {
                ...
                if(checkCType != "EWP")
                {
                    ...
                    Response.Write("<script>alert('"+ checkCType +":Consultationxx has ended. Please take the evaluation.');window.open('StudentSessionEvaluation.aspx?aId= "+ e.CommandArgument +"','_blank'); window.location ='StaffSessionAttendance.aspx'</script>");
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        Class2.exe(cmdUP);
                        populateListView();
                        Response.Write("<script>alert('"+ confirmValue +":Consultationzz has ended. Please take the evaluation.');window.open('StudentSessionEvaluation.aspx?aId= "+ e.CommandArgument +"','_blank'); window.location ='StaffSessionAttendance.aspx'</script>");
                    }
                }
            }
