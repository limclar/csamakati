        ...
        try
        {
            ...
            else if(e.CommandName == "TimeEnd")
            {
                ...
                if(checkCType != "EWP")
                {
                    ...
                    Response.Write("<script>alert('"+ checkCType +":Consultation has ended. Please take the evaluation.');window.open('StudentSessionEvaluation.aspx?aId= "+ e.CommandArgument +"','_blank'); window.location ='StaffSessionAttendance.aspx'</script>");
                }
                else
                {
