...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        SqlCommand cmdUser = new SqlCommand("UPDATE [dbo].[PeerAdviserConsultations] SET [TimeStart] = convert(char(8), DATEADD(hour,8,GETUTCDATE()), 108) WHERE [PConsultationId] =  " + Request.QueryString["aId"]);
        Class2.exe(cmdUser);
        populateListView();
    }
