...
<div style="background-color: #f2f2f2; width: 80%; margin-left: 10%; border: 2px solid black;">
    <table style="margin-left: 5%; margin-top: 2%;">
        <tr style="">
           ...
           <td>
               <asp:Label ID="Label1" runat="server" Text='<%#Class2.getSingleData("Select dbo.Student.StudentName from Student WHERE dbo.Student.StudentNumber = dbo.PeerAdviserConsultations.StudentNumber) FROM PeerAdviserConsultations WHERE dbo.PeerAdviserConsultations.PConsultationId = "+Request.QueryString["aId"]) %>' />
           </td>
           <td style="width: ;">
              <p> Peer Adviser: </p>
           </td>
